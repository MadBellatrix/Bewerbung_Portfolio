...
import './App.css'; // WICHTIG: CSS importieren
      ...
      <section id="home" className="section hero-section">
        <div className="terminal-window">
          ...
          <div className="terminal-body">
            <p className="cmd-line"><span className="prompt">$</span> {text}<span className="cursor">_</span></p>
            <p className="output-line">&gt; loading skills...</p>
            <p className="output-line">&gt; status: <span className="status-badge">ready_to_hire</span></p>
            
            <h1 className="hero-title">[ DEIN NAME ]</h1>
          ...
          {[
            ...
            { title: "Project Gamma", desc: "REST API & Auth System.", stack: ["Express", "JWT", "Jest"] }
              ...
              <div className="card-links">
                ...
                <a href="#"><ExternalLink size={14}/> Demo</a>
              </div>
            </div>
          ))}
        </div>
